...
- The argument management is pretty poor, but it gets the job done if you follow the instructions uwu.

Español:
- ASCII Maker es un script que genera una versión ASCII Art de un video. 
...
- El manejo de argumentos es bastante pobre, pero hace el trabajo si seguís las instrucciones uwu.
